          ...
          <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <DataTable :value="statuses" :paginator="true" :rows="5"
                         ...
                         :globalFilterFields="['id','module','description']" responsiveLayout="scroll">
                <template #header>
                ...
                <Column field="module" header="Module" sortable class="min-w-[20rem]">
                  <template #body="{data}">
                    {{data.module}}
                  </template>
                  <template #filter="{filterModel}">
...
let trace = [
  ...
  { description: 'Statuses', pathName: 'StatusList', isLink: true, current: true }
]
