              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="title" id="title" v-model="user.title" autocomplete="title" class="mt-1 focus:ring-amerinode-blue-500 focus:border-amerinode-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>

                  <div class="col-span-6 sm:col-span-3">
                    <label for="names" class="block text-sm font-medium text-gray-700">Name</label>
                    <input type="text" name="names" id="names" v-model="user.name" autocomplete="names" class="mt-1 focus:ring-amerinode-blue-500 focus:border-amerinode-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <Listbox v-model="selectedPerson">
                      <div class="relative mt-1">
                        <ListboxButton
                            class="relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-amerinode-blue-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-amerinode-blue-300 sm:text-sm"
                        >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <li
                                  :class="[
                  active ? 'bg-amerinode-blue-100 text-amerinode-blue-900' : 'text-gray-900',
